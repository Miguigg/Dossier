        ...
        <div className="login-container gradient-bg-landing">
          ...
          <form onSubmit={EliminarArticulo}>
            ...
            <div>
                ...
                <select class="form-select form-select mb-3" aria-label="Large select example" disabled>
            ...
            <button type="submit" className="btn btn-success w-100 mt-3">Eliminar articulo</button>
